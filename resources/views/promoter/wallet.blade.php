    ...
    <div class="inner_content">
        ...
        <div class="inner_content_w3_agile_info">
            ...
            <div class="w3ls_agile_cylinder chart agile_info_shadow">
                ...
                @endif
                <h3 class="w3_inner_tittle two" id="withdraw">Withdraw Your Funds</h3>
                <table id="table">
                    <thead>
                        <tr>
                            <p>Minimum Withdrawal is ₦3,000 </p>
            ...
            <div class="w3ls_agile_cylinder chart agile_info_shadow">
                ...
                <div class="work-progres">
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($withdrawal->status == 'successful')
                                                <span class="label label-success">{{ ucwords($withdrawal->status) }}</span>
                                            @elseif($withdrawal->status == 'unsuccessful')
                                                <span class="label label-danger">{{ ucwords($withdrawal->status) }}</span>
                                            @else
                                                <span class="label label-warning">{{ ucwords($withdrawal->status) }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    @php $num++; @endphp
                        ...
                        {{ $withdrawals->onEachSide(4)->links() }}
                    </div>
                </div>
            </div>
            <!-- /w3ls_agile_circle_progress-->
