...
@section('content')
    ...
    2,
            ...
            <div class="w3ls_agile_cylinder chart agile_info_shadow">
                ...
                <h3 class="w3_inner_tittle two">Request Withdrawal</h3>
                <table id="table">
                    <thead>
                        <tr>
                            ...
                            <form action="">
                                <th>
                                    <div class="input-group">
                                        ...
                                        <input id="withdrawal-input" type="number" style="font-size: 15px;" required
                                            placeholder="Enter the amount to Withdraw" class="form-control1 icon">
                                    </div>
